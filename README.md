...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-riq8ara.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-riq8ara.containers.anotherwebservice.com/
...
```
git clone git@github.com:myakhlaqi/container-riq8ara.git
cd container-riq8ara
```
...
```
docker attach container-riq8ara
```
